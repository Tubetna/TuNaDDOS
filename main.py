...
def title():
    ...
    stdout.write("             "+Fore.CYAN                     +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.LIGHTBLUE_EX+"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.LIGHTBLUE_EX+"║ "+Fore.LIGHTWHITE_EX   +"  Chào mừng đến với màn hình chính của Karma  "+Fore.LIGHTBLUE_EX  +"      ║\n")
    stdout.write("             "+Fore.LIGHTBLUE_EX+"║ "+Fore.LIGHTWHITE_EX   +"          Nhập [help] để xem các Lệnh    "+Fore.LIGHTBLUE_EX +"           ║\n")
    stdout.write("             "+Fore.MAGENTA     +"║ "+Fore.LIGHTWHITE_EX   +"        Contact Dev - vietsub by Tubetna   "+Fore.MAGENTA+"         ║\n")
    stdout.write("             "+Fore.MAGENTA     +"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def command():
